function WeatherApp() {
    ...
    this.apiKey = "c1ad54a4fb4cd42dd6091e0afedae2df"; // Replace with your actual API key (trimmed)
...
WeatherApp.prototype.getWeatherData = async function(city) {
    ...
    try {
        ...
        const [current, forecast] = await Promise.all([
            axios.get(`${this.currentWeatherUrl}?q=${city}&appid=${this.apiKey}&units=metric`),
